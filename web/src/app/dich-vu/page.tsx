...
const SERVICES_DETAIL = [
  {
    ...
    img: 'https://res.cloudinary.com/dmjrk2fov/image/upload/v1774550285/anphuoc/pages/dich-vu/e5ei7oz5owrxr5j7ftih.jpg',
    reverse: false,
  },
  {
    num: '02',
    ...
    img: 'https://res.cloudinary.com/dmjrk2fov/image/upload/v1774550284/anphuoc/pages/dich-vu/l9zwwgtoue8ghwl3q7bq.jpg',
    reverse: true,
  },
  {
    num: '03',
    ...
    img: 'https://res.cloudinary.com/dmjrk2fov/image/upload/v1774550340/anphuoc/pages/trang-chu/sgrwwcpjjzaqlagamurn.jpg',
    reverse: false,
  },
]
    ...
    <>
      ...
      <main>
        ...
        <section className="relative h-[60vh] min-h-[450px] flex items-end pb-14">
          ...
          <img src="https://res.cloudinary.com/dmjrk2fov/image/upload/v1774550297/anphuoc/pages/dich-vu/jztocm2b54wwgfqrdfc3.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" />
