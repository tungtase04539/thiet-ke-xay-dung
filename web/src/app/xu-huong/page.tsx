    ...
    <>
      ...
      <main>
        ...
        <section className="relative h-[45vh] min-h-[350px] flex items-end pb-12">
          ...
          <img src="https://res.cloudinary.com/dmjrk2fov/image/upload/v1774550401/anphuoc/projects/05-noi-that-hien-dai-sang-trong/ol1f2hezuwaoivaqkt1g.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" />
