...
const PROJECTS = [
  {
    ...
    materials: [],
    tags: ['nhà phố hiện đại', 'thiết kế nhà phố', 'nhà phố Hải Phòng', 'Thủy Nguyên'],
  ...
  },
  {
    ...
    materials: [],
    tags: ['biệt thự tân cổ điển', 'thiết kế biệt thự', 'biệt thự đẹp', 'xây dựng Hải Phòng'],
  ...
  },
  {
    ...
    materials: [],
    tags: ['thiết kế spa', 'spa hiện đại', 'thương mại Hải Phòng', 'Modern Minimalist'],
  ...
  },
  {
    ...
    materials: [],
    tags: ['nhà phố tân cổ điển', 'thiết kế nhà phố', 'nhà phố Hải Phòng', 'xây dựng trọn gói'],
  ...
  },
  {
    ...
    materials: [],
    tags: ['nội thất hiện đại', 'nội thất phòng khách', 'thiết kế nội thất', 'phòng khách liền bếp'],
  ...
  },
  {
    ...
    materials: [],
    tags: ['nội thất tối giản', 'thiết kế nội thất', 'Modern Minimalist', 'nội thất Hải Phòng'],
  ...
  },
  {
    ...
    materials: [],
    tags: ['nội thất nhà phố', 'thiết kế nội thất', 'nhà phố hiện đại', 'Thủy Nguyên'],
  ...
  },
  {
    ...
    materials: [],
    tags: ['xây dựng trọn gói', 'thi công spa', 'xây dựng Hải Phòng', 'spa đẹp'],
  ...
  },
  {
    ...
    materials: [],
    tags: ['xây dựng nhà phố', 'thi công trọn gói', 'nhà phố tân cổ điển', 'xây dựng Hải Phòng'],
