        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
              ...
              <line x1="14" y1="1" x2="14" y2="27" stroke="#C9A84C" strokeWidth="0.5" opacity="0.4"/>
              <line x1="1" y1="8" x2="27" y2="20" stroke="#C9A84C" strokeWidth="0.5" opacity="0.4"/>
              <line x1="27" y1="8" x2="1" y2="20" stroke="#C9A84C" strokeWidth="0.5" opacity="0.4"/>
            </svg>
            <div>
              <div className="font-display text-xl tracking-[0.2em] text-text font-semibold leading-none group-hover:text-gold transition-colors">
                ATELIER
              </div>
              <div className="text-[9px] tracking-[0.3em] text-text-muted leading-none mt-0.5">
                INTERIOR DESIGN
              </div>
            </div>
          </Link>
      ...
      >
        ...
        >
          <div className="flex justify-between items-center p-6 border-b border-border">
            <span className="font-display text-lg tracking-[0.2em] text-gold">ATELIER</span>
