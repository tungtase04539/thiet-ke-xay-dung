      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2.5 mb-5">
              <svg width="26" height="26" viewBox="0 0 28 28" fill="none">
                ...
                <polygon points="14,6 22,10.5 22,17.5 14,22 6,17.5 6,10.5" stroke="#C9A84C" strokeWidth="0.6" fill="rgba(201,168,76,0.05)"/>
              </svg>
              <div>
                <div className="font-display text-base tracking-[0.2em] text-text">ATELIER</div>
                <div className="text-[8px] tracking-[0.3em] text-text-muted">INTERIOR DESIGN</div>
              </div>
            </Link>
            <p className="text-text-muted text-sm leading-relaxed mb-6 max-w-xs">
              Chúng tôi không chỉ thiết kế không gian — chúng tôi kiến tạo những trải nghiệm sống đáng nhớ cho từng gia đình.
            </p>
            <div className="space-y-2 text-sm text-text-muted">
              <div className="flex items-start gap-2">
                <MapPin size={14} className="text-gold mt-0.5 shrink-0" />
                <span>Tầng 5, Số 12 Lê Văn Lương, Thanh Xuân, Hà Nội</span>
              </div>
              <div className="flex items-center gap-2">
                <Phone size={14} className="text-gold shrink-0" />
                <a href="tel:0922229787" className="hover:text-gold transition-colors">0922 22 9787</a>
              </div>
              <div className="flex items-center gap-2">
                <Mail size={14} className="text-gold shrink-0" />
                <a href="mailto:hello@atelier.vn" className="hover:text-gold transition-colors">hello@atelier.vn</a>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-text-muted tracking-wide">
            © 2024 ATELIER Interior Design. Giấy phép ĐKKD số 0123456789.
          </p>
