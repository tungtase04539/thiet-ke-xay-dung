            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select value={form.type} onChange={e => set('type', e.target.value)} className={inputClass}>
                  {['Căn hộ','Penthouse','Villa','Biệt thự','Văn phòng'].map(v=><option key={v}>{v}</option>)}
                </select>
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select value={form.style} onChange={e => set('style', e.target.value)} className={inputClass}>
                  {['Neo-Classic','Modern Luxury','Indochine','Tropical Modern','Scandinavian','Contemporary'].map(v=><option key={v}>{v}</option>)}
                </select>
              </div>
              <div>
