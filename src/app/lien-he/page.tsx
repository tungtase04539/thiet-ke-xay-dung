    ...
    <>
      ...
      <main>
        ...
        <section className="relative h-[38vh] min-h-[280px] flex items-end pb-12">
          ...
          <img src="https://images.unsplash.com/photo-1600210492493-0946911123ea?w=1920&q=80" alt="" className="absolute inset-0 w-full h-full object-cover" />
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3 text-text-muted text-sm">
                    ...
                    Tầng 5, Số 12 Lê Văn Lương, Thanh Xuân, Hà Nội
                  </li>
                  ...
                  <li className="flex items-center gap-3 text-sm">
                    ...
                    <a href="mailto:hello@atelier.vn" className="text-text hover:text-gold transition-colors">hello@atelier.vn</a>
                  </li>
              ...
              <div className="rounded-sm overflow-hidden border border-border bg-surface h-48 flex items-center justify-center text-text-muted text-sm">
                <div className="text-center">
                  ...
                  Tầng 5, Số 12 Lê Văn Lương<br />Thanh Xuân, Hà Nội
                </div>
              </div>
            </div>
                ...
                <form onSubmit={submit} className="glass rounded-sm p-8 space-y-5">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <label htmlFor="agree" className="text-sm text-text-muted cursor-pointer">
                      Tôi đồng ý với <span className="text-gold">chính sách bảo mật</span> và cho phép ATELIER liên hệ tư vấn.
                    </label>
                  </div>
