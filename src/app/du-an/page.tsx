...
const STYLES = ['Tất Cả', 'Neo-Classic', 'Modern Luxury', 'Indochine', 'Tropical Modern', 'Scandinavian', 'Contemporary']
const TYPES = ['Tất Cả', 'Căn hộ', 'Penthouse', 'Villa', 'Biệt thự']
    ...
    <>
      ...
      <main>
        ...
        <section className="relative h-[50vh] min-h-[400px] flex items-end pb-12">
          ...
          <img src="https://images.unsplash.com/photo-1616137466211-f939a420be84?w=1920&q=80" alt="" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
            ...
            <p className="text-text-muted mt-3">150+ công trình cao cấp được hoàn thiện trên toàn quốc</p>
          </div>
        </section>
                ...
                {filtered.slice(0, visible).map((p, i) => (
                  <Link key={p.id} href={`/du-an/${p.slug}`}
                    ...
                    <div className="absolute bottom-0 left-0 p-5 translate-y-2 group-hover:translate-y-0 transition-transform duration-400">
                      ...
                      <p className="text-text-muted text-xs mt-1">{p.type} · {p.area}m²</p>
